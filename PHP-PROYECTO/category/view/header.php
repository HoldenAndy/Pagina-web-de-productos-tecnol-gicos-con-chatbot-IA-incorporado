      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <form class="form-inline my-2 my-lg-0">
                  <div class="busqueda">
                    ...
                    <img src="../assets/img/imgIndex/botonBuscar.png" width="20" align="20"></button>
                  </div> 
                </form>
              </li>
            </div>
            ...
            <div class="container-servicios">  
              ...
              <a class="nav-link" href="inicioSesion.php"> <img src= "../assets/img/imgIndex/miCuenta.jpg" class="imgCuenta" width="40" align="40"> </a>     
    <div>
      <lu>
        <li class="submenu">
              <a class="nav-link" href="#"><img src= "../assets/img/imgIndex/miCarrito.png" class="imgCarrito" width="40" align="40"> </a>
              <div id="carrito">
